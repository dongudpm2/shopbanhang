...
<tr><td align="center"><a href="giohang.php"><input type="button" value="Mua hàng"></a><a href="Chitiet.php"><input type="button" value="Chi tiết"></a><a href="xoa.php"><input type="button" value="Xóa"></a><a href="sua.php"><input type="button" value="Sửa"></a>
</td></tr>
</table>
</div>
</form></div>
